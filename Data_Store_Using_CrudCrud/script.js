function saveToCrud(event){
  ...
  axios.post('https://crudcrud.com/api/e35e8c918a4a4de4a171daa7d24eafe7/UserData',obj)
  .then(res=>{
...
window.addEventListener('DOMContentLoaded',()=>{
  axios.get('https://crudcrud.com/api/e35e8c918a4a4de4a171daa7d24eafe7/UserData')
  .then((res)=>{
...
childElement.textContent = obj.itemName + "-" + obj.desc +"-"+ obj.price+ "-" + obj.quantity; 
  ...
  btn1.onclick=()=>{
     ...
     axios.put(`https://crudcrud.com/api/e35e8c918a4a4de4a171daa7d24eafe7/UserData/${id}`,updatedValues)
     .then(()=>{
